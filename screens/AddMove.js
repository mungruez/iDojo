      ...
      {type === 'video' ? (
        ...
        <View style={{ marginTop: 10 }}>
          ...
          <TouchableOpacity style={styles.addStepBtn} onPress={() => setSteps([...steps, { id: Date.now().toString(), title: '',img: null, desc: '' }])}>
            <ImageBackground style={{width: '100%', height: 38, justifyContent: 'center'}} resizeMode='contain' source={require('../assets/greenbtnbg.png')}>
              <Image
                resizeMode="contain"
                style={{ height:29, width: 133, alignSelf:"center",}}
