...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#990808', textAlignVertical="top", borderRadius: 8, padding: 8, marginTop: 7, backgroundColor: 'rgba(212, 29, 54, 0.1)', },
  ...
  stepInput: { borderWidth: 1, borderColor: '#083a1d', padding: 8, textAlignVertical="top", backgroundColor: 'rgba(93, 231, 167, 0.5)', borderRadius: 8,},
