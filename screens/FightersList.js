...
const styles = StyleSheet.create({ 
  ...
  quoteinput: { borderWidth: 2.5, borderColor: '#7e6b15', borderRadius: 12, padding: 3, marginTop: 3, backgroundColor: 'rgba(235, 224, 71, 0.57)', opacity: 1, fontWeight: "bold", fontSize: 13, width: "95%" - 114, marginLeft: 7, marginBottom: 9 },
