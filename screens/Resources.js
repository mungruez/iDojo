...
<Text style={ styles.title }>iDojo's hand picked list of online videos and shorts for Self Defense, with our Featured Move Of The Day. Whether your looking for one to one paid training or just a quick watch and learn, then, this iDojo's Featured List has it. Each video must meet certain criteria in order to be considered effective Self Defense Training. WiFi is necessary for this section as Featured videos are copyrighted. Please contact us on social media to have your suggested videos in our Featured List.
</Text>

<Text style={ styles.freeyourmind }>Free Your Mind:</Text>
<Text style={ styles.title }>Audio for a healthy mind that will motivate Self Defense learning and intense training. Each Audio is carefully handcrafted to be interlectually, heart touching to enable you to free your mind. When playing audio, click the purple bar in the slider for seeking.
</Text>
