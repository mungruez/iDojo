...
sectionHeader: { color: '#33fc4d', fontSize: 14, fontWeight: 'bold', marginBottom: 9, textTransform: 'uppercase', letterSpacing: 1, backgroundColor: 'rgba(37, 37, 37, 0.76)', alignSelf: "flex-start", opacity: 1 },
sectionHeaderVideo: { color: '#701210', fontSize: 14, fontWeight: 'bold', marginBottom: 9, textTransform: 'uppercase', letterSpacing: 1, backgroundColor: 'rgb(255, 255, 253)', alignSelf: "flex-start", opacity: 1 },
sectionHeaderPdf: { color: '#131375', fontSize: 14, fontWeight: 'bold', marginBottom: 9, textTransform: 'uppercase', letterSpacing: 1, backgroundColor: 'rgba(247, 247, 223, 0.9)', alignSelf: "flex-start", opacity: 1 },
