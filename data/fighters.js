export const fighters = [
    {
      id: "1",
      name: 'Muhammad Ali', 
      avatar: require('../assets/avatars/muhammadali.png'),
      desc: ["Ali is known as one of the best boxers of all time, he fought nine times in bouts that showed him to be a courageous fighter. One strategy he used was instead of moving around the ring, Ali chose to fight for extended periods of time leaning back into the ropes in order to avoid many of the heaviest blows.", "Float like a butterfly, sting like a bee.", "It's the repetition of affirmations that leads to belief. And once that belief becomes a deep conviction, things begin to happen.", "It isn't the mountains ahead to climb that wear you out; it's the pebble in your shoe.", "Life is a gamble. You can get hurt, but people die in plane crashes, lose their arms and legs in car accidents; people die every day. Same with fighters: some die, some get hurt, some go on. You just don't let yourself believe it will happen to you.", "Life is a gamble. You can get hurt, but people die in plane crashes, lose their arms and legs in car accidents; people die every day. Same with fighters: some die, some get hurt, some go on. You just don't let yourself believe it will happen to you.", "If they can make penicillin out of mouldy bread, they can sure make something out of you.", "I am an ordinary man who worked hard to develop the talent I was given. I believed in myself, and I believe in the goodness of others."],
      style: "Boxing",
      conc: "",
      moves:[
        {
          id: "11",
          title:"Phantom Punch",
          img: require('../assets/fighters/muhammadaliphantompunch.png'),
          desc: "In 1964 Muhammad Ali shook up the world by defeating Sunny Liston. Afterwards many believed the occurrence to be a fluke. Their second fight should have put that notion to rest as Ali knocked Liston out in the very first round of their rematch. The moment was captured in what became one of the most iconic sports pictures ever taken. Ali standing over Liston screaming at him to get up. Ali assumed that he had put any doubt about his legitimacy to rest instead the knockout became one of the most controversial highly debated sports moments ever. A great deal of fans and even professionals in the boxing world believed that Liston had taken a dive and some claim that Ali had never thrown a punch at all, giving rise to the conspiracy theory of the phantom punch the controversy was so great that a segment aired on TV with boxing experts discussing the matter. The guests included former heavyweight champions Jack Dempsey and Rocky Marciano but as slow-motion footage later revealed ali's punch did in fact connect.",
        },
        {
          id: "12",
          title: "Muhammad Ali Dodges 21 punches",
          img: require('../assets/fighters/muhammadalidodging.png'),
          desc: "Muhammad Ali showed off his speed and agility in a 1977 fight against Michael Dokes At the 1:56 mark, Ali gets backed into a corner and begins dodging all of Dokes’ punches with incredible speed and agility. Over the course of 10 seconds, Ali dodges 21 punches and then moves away from the corner with a good amount of swagger, taunting Dokes with a little dance. A throwback video is available on YouTube.",
        }
      ]
    },
    {
      id: "2",
      name: 'Bruce Lee', 
      avatar: require('../assets/avatars/brucelee.png'),
      desc:["Bruce Lee wasn't just one of the greatest martial artists of all time, pound-for-pound he might also be one of the greatest athletes and no technique shows that off quite as well as his legendary one-inch punch.", "The more relaxed the muscles are, the more energy can flow through the body. using muscular tensions to try to do the punch or attempting to use brute force to knock someone over will only work to the opposite effect."],
      style: "Jeet Kune Do",
      conc: "",
      moves:[
        {
          ...
          img: require('../assets/fighters/bruceleeoneinchpunch.png'),
      ...
      },
      {
        id: "22",
          title: "Side Kick",
          img: require('../assets/fighters/bruceleesidekick.png'),
    ...
    },
    {
      ...
      moves:[
        ...
        },
        {
          ...
          img: require('../assets/fighters/pacmancounterpunchgf.jpg'),
